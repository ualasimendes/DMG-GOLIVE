    ...
    <>
      ...
      <aside
        ...
        className={`
          ...
          bg-[#0a0c14] border-l border-[#191d2c] flex flex-col h-full shrink-0 select-none font-sans shadow-2xl md:shadow-none
      ...
      >
        ...
        <div className="p-3.5 border-b border-[#191d2c] bg-[#0d0f19]">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              {isCallerAdmin1 && (
                <span className="px-2 py-0.5 rounded bg-gradient-to-r from-red-600 to-amber-600 text-white text-[9px] font-black tracking-wider uppercase shadow-sm flex items-center gap-1">
                  <Crown className="w-3 h-3" />
                  ADMIN 1
                </span>
              )}
              {isCallerAdmin2 && (
                <span className="px-2 py-0.5 rounded bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-[9px] font-bold tracking-wider uppercase shadow-sm flex items-center gap-1">
              ...
              <button
                ...
                title="Voltar para a transmissão"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
          ...
          <div className="flex items-center gap-1.5 bg-[#121524] rounded-xl p-1.5 border border-[#20253c]">
        ...
        {/* Tabs (Chat / Participantes) */}
        <div className="flex border-b border-[#191d2c] bg-[#0a0c14]">
          <button
            onClick={() => setActiveTab('chat')}
            className={`flex-1 py-2.5 text-xs font-bold flex items-center justify-center gap-1.5 transition-colors border-b-2 cursor-pointer ${
              activeTab === 'chat'
                ? 'text-indigo-400 border-indigo-500 bg-[#121525]/40'
        ...
        {activeTab === 'participants' ? (
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-2">
            <div className="text-[11px] font-bold text-zinc-500 uppercase tracking-wider px-2 py-0.5 flex items-center justify-between">
              <span>Conectados</span>
              <span>Volume & Ações</span>
            </div>
                ...
                <div
                  ...
                  className={`p-2.5 rounded-xl border transition-all space-y-2 ${
                    isStreaming
                      ...
                      : 'bg-[#111322] border-[#1d2238]'
                  }`}
                >
                  <div className="flex items-center justify-between gap-2">
                    <div
                      onClick={() => isStreaming && onSelectStreamer(user.id)}
                      className={`flex items-center gap-2.5 min-w-0 flex-1 ${isStreaming ? 'cursor-pointer' : ''}`}
                    >
                      ...
                      <div className="relative shrink-0">
                        {user.avatar ? (
                          <img
                            src={user.avatar}
                            alt={user.name}
                            className={`w-8 h-8 rounded-full object-cover border border-[#242b44] bg-zinc-800 ${
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          {/* Role Badge */}
                          {isTargetAdmin1 && (
                            <span className="px-1.5 py-0.2 rounded bg-gradient-to-r from-red-600 to-amber-600 text-white text-[8px] font-black tracking-wider uppercase shadow-xs">
                              ADMIN 1
                            </span>
                          )}
                          {isTargetAdmin2 && (
                            <span className="px-1.5 py-0.2 rounded bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-[8px] font-bold tracking-wider uppercase shadow-xs">
                              ADMIN 2
                            </span>
                          )}
                        </div>
                    ...
                    {/* Mute status & Action toggle */}
                    <div className="flex items-center gap-1 shrink-0">
                      {user.isMuted && (
                        <span title="Microfone silenciado" className="text-red-400 p-1">
                  ...
                  {!isMe && (
                    <div className="flex items-center gap-2 pt-1 border-t border-[#1b2034] text-[11px] text-zinc-400">
                      <button
                        ...
                        title={userVol === 0 ? 'Desmutar' : 'Mutar'}
                      >
                        {userVol === 0 ? (
                  ...
                  {selectedUserActionMenu === user.id && (
                    <div className="bg-[#0c0e18] border border-[#22283e] rounded-xl p-1.5 space-y-1 animate-in fade-in zoom-in-95 text-xs">
                      {isCallerAdmin1 && (
                        <>
                          <button
                            onClick={() => {
                            ...
                            className="w-full text-left px-2 py-1.5 hover:bg-indigo-950/60 text-indigo-300 rounded-lg flex items-center gap-1.5 cursor-pointer text-[11px]"
                          >
                          ...
                          <button
                            ...
                            className="w-full text-left px-2 py-1.5 hover:bg-amber-950/60 text-amber-300 rounded-lg flex items-center gap-1.5 cursor-pointer text-[11px]"
                          >
                          ...
                          {userRole !== 'member' && (
                            <button
                              ...
                              className="w-full text-left px-2 py-1.5 hover:bg-zinc-800 text-zinc-400 rounded-lg flex items-center gap-1.5 cursor-pointer text-[11px]"
                            >
                      ...
                      <button
                        ...
                        className="w-full text-left px-2 py-1.5 hover:bg-zinc-800 text-zinc-200 rounded-lg flex items-center gap-1.5 cursor-pointer text-[11px]"
                      >
                      ...
                      <button
                        ...
                        className="w-full text-left px-2 py-1.5 hover:bg-red-950/50 text-red-400 rounded-lg flex items-center gap-1.5 cursor-pointer text-[11px]"
                      >
                      ...
                      {isCallerAdmin1 && (
                        <button
                          ...
                          className="w-full text-left px-2 py-1.5 hover:bg-red-900/60 text-red-300 font-bold rounded-lg flex items-center gap-1.5 cursor-pointer text-[11px]"
                        >
          ...
          <div className="flex-1 flex flex-col min-h-0">
            {/* YouTube Jukebox Dock */}
            {activeYouTubeTrack && (
              <div className="p-2 border-b border-red-900/30 bg-red-950/20">
                <YouTubeJukebox
            ...
            <div ref={chatScrollRef} className="flex-1 overflow-y-auto p-3 space-y-2.5">
              {messages.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center p-4 text-zinc-500">
                  ...
                  <p className="text-xs font-semibold text-zinc-400">Nenhuma mensagem ainda</p>
                  <p className="text-[11px] text-zinc-500 mt-1">
                    Envie uma mensagem ou use <code>!help</code> para comandos!
                  </p>
                </div>
              ) : (
                messages.map((msg) => {
              ...
              >
                ...
                <div className="flex gap-1.5">
                  <input
                    type="text"
                    autoFocus
                    placeholder="Link do YouTube (ex: youtube.com/watch?v=...)"
                    value={musicUrlInput}
                    onChange={(e) => setMusicUrlInput(e.target.value)}
                    className="flex-1 bg-[#121524] border border-red-800/60 rounded-xl px-3 py-1.5 text-xs text-white placeholder-zinc-500 focus:outline-none focus:border-red-500"
                  />
                  <button
                    type="submit"
                    disabled={!musicUrlInput.trim()}
                    className="px-3.5 py-1.5 bg-red-600 hover:bg-red-500 text-white rounded-xl text-xs font-bold transition-all disabled:opacity-40 cursor-pointer"
                  >
                    Tocar
                  </button>
                </div>
            ...
            <div className="px-2.5 py-2 border-t border-[#191d2c] flex items-center justify-between bg-[#0a0c14]">
              {/* DJ Bot Launcher Button */}
              {isCallerAdmin ? (
                <button
                  onClick={() => setShowMusicPrompt(!showMusicPrompt)}
                  className="flex items-center gap-1.5 px-2.5 py-1 bg-red-950/60 hover:bg-red-900/80 border border-red-800/60 text-red-300 rounded-xl text-[11px] font-bold transition-all active:scale-95 cursor-pointer"
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-2.5 py-1 bg-[#141726] hover:bg-[#1a1e32] border border-[#22283e] text-zinc-300 rounded-xl text-[11px] font-semibold transition-all active:scale-95 cursor-pointer"
              ...
              <div className="flex items-center gap-1">
                {[
                  ...
                  <button
                    ...
                    className="w-7 h-7 rounded-lg hover:bg-zinc-800 flex items-center justify-center text-xs transition-transform active:scale-125 cursor-pointer"
                    title={item.label}
                  >
                    {item.emoji}
                  </button>
            ...
            <form onSubmit={handleSend} className="p-3 border-t border-[#191d2c] bg-[#0d0f19]">
              <div className="flex items-center gap-2 bg-[#121524] rounded-2xl p-1.5 border border-[#22283e] focus-within:border-indigo-500 transition-colors">
                <input
                  type="text"
                ...
                <button
                  ...
                  className="p-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white disabled:opacity-30 disabled:hover:bg-indigo-600 transition-all cursor-pointer"
                  title="Enviar"
                >
